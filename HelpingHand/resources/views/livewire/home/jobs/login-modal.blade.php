<div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="registermodal" aria-hidden="false" 
   >
        ...
        <div class="modal-content" id="registermodal">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" ><span
                        aria-hidden="true"><i class="ti-close" wire:click="update_login"></i></span></button>
            </div>
                ...
                <div class="login-form">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="email" placeholder="Username">
                        </div>
